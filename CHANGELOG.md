...
## [0.4.0] - 2026-05-07
### Added
- Add support for DPI-C export function callbacks from Python
- Add Verilator coverage for 1-D and non-square multidimensional arrays

### Fixed
- Fix multidimensional array strides for Python buffer views
- Fix dimension handling for `DataType.IntArray[n]`
